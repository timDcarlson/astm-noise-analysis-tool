...
\vspace{-36pt} 
\end{wrapfigure}
The fixture has no S2D2 lamp installed, but is wrapped in padding for shipping transport.  Open the door of the fixture and unwrap the brown paper padding from the S2D2 lamp housing.  Reassemble an S2D2 lamp back in the enclosure as outlined in  section \ref{lampReassembly}.
